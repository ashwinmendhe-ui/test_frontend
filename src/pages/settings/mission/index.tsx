...
export default function Mission() {
  ...
  const handleEdit = (
    record: MissionManagementTable
  ) => {
    navigate(
      `/settings/mission/${record.missionId}/edit`
    );
  };
  ...
  const columns = [
...

    {
      ...
      render: (value: string) => {
        ...
        const label =
          type === "Drone"
            ? t("mission_device_type_drone")
            : type === "Robot"
            ? t("mission_device_type_robot")
            : value || "-";
